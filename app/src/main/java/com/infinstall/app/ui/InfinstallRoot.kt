                    ...
                    Column(
                        ...
                        when (state.tab) {
                            ...
                            MainTab.Files -> FilesScreen(
                                ...
                                onGoConnect = { vm.selectTab(MainTab.Connect) },
                                onShortcut = vm::setRemotePath,
                                onCreateFolder = vm::createFolder,
                                onRename = vm::renameRemote,
                                onCopy = { vm.copyToClipboard(it, cut = false) },
                                onCut = { vm.copyToClipboard(it, cut = true) },
                                onPaste = vm::pasteClipboard,
                                onClearClipboard = vm::clearClipboard,
                                onLoadProps = vm::loadProps,
                                onDismissProps = vm::dismissProps,
